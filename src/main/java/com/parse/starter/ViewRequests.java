...
public class ViewRequests extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        longitutes = new ArrayList<Double>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("longitude", longitutes.get(position));
                i.putExtra("userLatitude", location.getLatitude());
                i.putExtra("userLongitude", location.getLongitude());
                startActivity(i);

                Log.i("MyApp", usernames.get(position) + latitudes.get(position).toString() + longitutes.get(position).toString());
            }
        });
    ...
    public void updateLocation(Location location){
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    Log.i("MyApp", "Locations found");
                    if(e == null){

                        if(objects.size() >0){
                            Log.i("MyApp", "Locations are there");
                            ...
                            for(ParseObject object : objects){
                                ...
                                Double distanceInKilometeres = userLocation.distanceInKilometersTo((ParseGeoPoint) object.get("requesterLocation"));

                                Double distanceOneDP = (double) Math.round(distanceInKilometeres* 10)/10;
                                ...
                                longitutes.add(object.getParseGeoPoint("requesterLocation").getLongitude());
                            }
